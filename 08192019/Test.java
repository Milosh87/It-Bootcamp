...
public class Test {
	...
	public static void main(String[] args) {
		...
		System.out.println(love_supreme.getMuzickaNumera(5));				// numera koja ne postoji(NULL)
		System.out.println(love_supreme.getMuzickaNumera("milos"));			// numera koja ne postoji(NULL)
		System.out.println(love_supreme.getMuzickaNumera("Part IV: Psalm"));	// numera koja postoji
		System.out.println(love_supreme.getMuzickaNumera(0));  // numera koja postoji
		System.out.println(love_supreme.getDatum());		// get datum test
